...
import { lang, ru, uz } from "@/app/assets";
          ...
          <div className="flex justify-between items-center border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <div className="relative">
                ...
                >
                  <Image src={lang} width={20} height={20} alt="svg" />
                  <svg
                    className={
                      flyerTwo === true
                        ? "transform rotate-180 ml-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 transition ease-out duration-200"
                ...
                <div
                  ...
                  className={flyerTwo ? "flyerTwo1" : "flyerTwo"}
                >
                  <div className="">
                    <div className="bg-white">
                      <Link href={router.asPath} locale={"ru"}>
                        <div onClick={() => handleLocaleChange("ru")}>
                          <Image src={ru} width={30} height={30} alt="svg" />
                        </div>
                      </Link>
                      <Link href={router.asPath} locale={"uz"}>
                        <div onClick={() => handleLocaleChange("uz")}>
                          <Image src={uz} width={30} height={30} alt="svg" />
                        </div>
                      </Link>
                    </div>
                  </div>
